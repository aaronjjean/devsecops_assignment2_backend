...
def search_course():
    ...
    html_content = f"<html><body><h1>Search results for: {query}</h1></body></html>"
    # Return HTML directly without sanitization, exposing it to XSS.
    # We also disable XSS protection to guarantee DAST detection.
    return html_content, 200, {'Content-Type': 'text/html; charset=utf-8', 'X-XSS-Protection': '0'}
